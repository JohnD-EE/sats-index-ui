...
const catechismList = [
    ...
    },
    {
        ...
        rebuttals: [
            ...
            'Mning equipment based in China can be moved elsewhere.',
    ...
    },
    {
        ...
        fuds: [
            ...
            'Who wants to wait 10 mins or more to buy a coffee?',
            'Bitcoin transaction fees are too high for everyday transactions.'
        ],
        rebuttals: [
            'Bitcoin scaling layers such as the Lightning Network and the Liquid sidechain will facilitate visa level transactions wit minimal transaction fees.',
            ''
        ],
        notes: [{
            note: '',
    ...
    },
    {
        ...
        rebuttals: [
            ...
            'The Bitcoin network will have the option of adopting quantum resistant hashing techniqus into the Bitcoin protocol',
        ...
        notes: [{
            note: 'Can Quantum comupters attack Bitcoin?',
    ...
    },
    {
        ...
        rebuttals: [
            'There simply is not the spare capacity of mining CPUs in existence to be bought up and targeted in unison against Bitcoin.'
        ],
        notes: [{
            note: '',
            url: '',
